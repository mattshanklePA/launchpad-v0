...
// seed: with the default lib/similarity.ts threshold (0.07), 8 of the 9 seed
// items cross-flag each other on generic token overlap, which read as a bug
// in a demo ("why is everything a duplicate?"). At the roll-up's stronger
// threshold, only the seed's intentional Census/ITA near-duplicate pair
// should surface.
